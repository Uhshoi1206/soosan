...
import TruckCatalog from "./pages_old/TruckCatalog";
import TruckDetail from "./pages_old/TruckDetail";
import ContactPage from "./pages_old/ContactPage";
import AboutPage from "./pages_old/AboutPage";
import NotFound from "./pages_old/NotFound";
import BlogPage from "./pages_old/BlogPage";
import BlogPostPage from "./pages_old/BlogPostPage";
import BlogCategoryPage from "./pages_old/BlogCategoryPage";
import SearchPage from "./pages_old/SearchPage";
import ComparePage from "./pages_old/ComparePage";
import CostEstimationPage from "./pages_old/CostEstimationPage";
import LoanCalculatorPage from "./pages_old/LoanCalculatorPage";
