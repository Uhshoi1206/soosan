...
const ContactPage = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Liên Hệ | soosanmotor.com - Nhà sản xuất sơ mi rơ moóc, cẩu, thùng xe tải đông lạnh, Xe xitéc (bồn) chở xăng dầu, xe chuyên dụng hàng đầu tại Việt Nam</title>
        <meta name="description" content="Liên hệ với soosanmotor.com để được tư vấn và báo giá tốt nhất cho xe tải, xe cẩu, sơ mi rơ mooc, xe xitéc (bồn) chở xăng dầu và các loại xe chuyên dụng khác. Hotline: 0764 6789 01" />
      </Helmet>
      ...
      <div className="container mx-auto py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <Card className="p-6 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600">sales@soosanmotor.com</p>
          </Card>
          ...
          <Card className="p-6 flex flex-col items-center text-center">
            ...
            <p className="text-gray-600">Cụm công nghiệp Hạp Lĩnh, Phường Hạp Lĩnh, Tỉnh Bắc Ninh, Việt Nam</p>
          </Card>
                ...
                <p className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    Hotline: <a
                      ...
                      className="hover:underline font-semibold text-black"
                      aria-label="Gọi ngay 0764 6789 01"
                    >0764 6789 01</a> (Tư vấn miễn phí 24/7)
                  </span>
                </p>
                <p className="flex items-start">
                  <Mail className="h-5 w-5 mr-2 text-primary flex-shrink-0" />
                  <span className="text-gray-700">Email: sales@soosanmotor.com</span>
                </p>
                <p className="flex items-start">
